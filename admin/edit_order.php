...
if(isset($_GET['order_id'])) {
    ...
    // Prepare and execute the query to select the order from the database
            ...
            <div class="table-responsive">
                <div class="mx-auto container">
                    <form id="edit-order-form" method="POST" action="edit_order.php">
                        ...
                        <p style="color: red;"><?php if(isset($_GET['error'])) { echo $_GET['error']; }?></p> <!-- Corrected closing PHP tag -->

                        <div class="form-group my-3">
                            <label>OrderId</label>
                            <p class="my-4"><?php echo $r['order_id'];?></p> <!-- Placeholder for OrderId -->
                        </div>

                        <div class="form-group mt-3">
                            <label>OrderPrice</label>
                            <p class="my-4"><?php echo $r['order_cost'];?></p> <!-- Placeholder for OrderPrice -->
                        </div>
